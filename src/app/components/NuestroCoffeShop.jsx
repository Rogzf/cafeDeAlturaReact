...
const NuestroCoffeShop = () => {
  return (
    <div className="flex justify-between py-[44px] px-[45px]">
        <div className="flex flex-col justify-center gap-4 w-[457px]">
          <h2 className="text-[24px] font-semibold leading-6 text-[#2A5B45]">
            Pruébalo en nuestro coffee shop
          </h2>
          <div className="text-[14px] font-normal leading-4 text-[#111827]">
          ...
          <div className="flex gap-4 items-center">
            <p className="text-[14px] font-semibold leading-4 underline">
              Cómo llegar
            </p>
            <Image
              className="w-[24px]"
